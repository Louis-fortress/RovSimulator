...
def launch_setup(context, *args, **kwargs): 
    ...
    xacro_file = os.path.join(
        get_package_share_directory('bluerov2_heavy_description'),
        'robots',
        'bluerov2_heavy_' + (Lc('mode')).perform(context) + '.xacro'
    )
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('namespace', default_value='bluerov2_heavy'),
